...
- **CHORE**: bump `flutter_full_screen_scanner_android` dependency to `^1.1.2`, `flutter_full_screen_scanner_ios` to `^1.1.2`, and `flutter_full_screen_scanner_platform_interface` to `^1.1.2`.
